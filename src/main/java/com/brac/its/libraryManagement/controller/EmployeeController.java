...
import com.brac.its.libraryManagement.model.Employee;
...
public class EmployeeController {
	...
	@GetMapping("/employee/records/reportv2")
	public ResponseEntity<byte[]> getEmployeeRecordReport2() {
		...
		try {
			...
			headers.setContentDispositionFormData("filename", "employees-details.xls");
			//create the report in PDF format
			return new ResponseEntity<byte[]>
					(JasperExportManager.exportReportToPdf(empReport), headers, HttpStatus.OK);
